...
function applyInline(text: string): string {
  // Zaman damgalarını yalnızca [MM:SS] veya [HH:MM:SS] formatındaysa linke çevir
  text = text.replace(/\[(\d{1,2}:\d{2}(?::\d{2})?)\]/g, '<span class="zy-timestamp-link" data-time="$1" style="color: #3b82f6; cursor: pointer; text-decoration: underline; font-weight: 600;">[$1]</span>');
